    ...
    <div>
      <div className="flex border-b-2 border-slate-100 items-center p-3">
				...
				<div className="flex ml-auto text-orange-300 font-medium space-x-4 pr-4 ">
					<div className="py-1 px-2 hover:bg-orange-50 text-sm rounded-md">HOME</div>
					<div className="py-1 px-2 hover:bg-orange-50 text-sm rounded-md">ROADMAP</div>
					<div className="py-1 px-2 hover:bg-orange-50 text-sm rounded-md">QUIZ</div>
					<div className="py-1 px-2 hover:bg-orange-50 text-sm rounded-md">SIGN IN</div>
				</div>
